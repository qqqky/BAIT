...
public final class SimpleSearchHelperDecrementalAbsolute extends AbstractSimpleSearchHelper implements CustomKeyGenerator {

    private static final Logger LOG = Logger.getLogger(SimpleSearchHelperDecrementalAbsolute.class.getName());
    ...
    public SimpleSearchHelperDecrementalAbsolute(@NonNull SimpleSearchHelperCreationContext creationContext) {
