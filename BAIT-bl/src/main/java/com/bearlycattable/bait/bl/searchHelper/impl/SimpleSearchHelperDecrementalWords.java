...
public final class SimpleSearchHelperDecrementalWords extends AbstractSimpleSearchHelper implements CustomKeyGenerator {
    ...
    private static final Logger LOG = Logger.getLogger(SimpleSearchHelperDecrementalWords.class.getName());
    ...
    public SimpleSearchHelperDecrementalWords(@NonNull SimpleSearchHelperCreationContext creationContext) {
