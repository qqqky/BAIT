...
public class AdvancedSubTabSearchControllerInitializer {
    ...
    public static AdvancedSubTabSearchControllerInitializer getInitializer(AdvancedSubTabSearchController controller, AdvancedTabMainController parentController) {
        return new AdvancedSubTabSearchControllerInitializer(controller, parentController);
    }
