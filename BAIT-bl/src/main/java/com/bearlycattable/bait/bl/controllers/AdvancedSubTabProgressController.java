...
public class AdvancedSubTabProgressController {
    ...
    public Optional<ThreadComponentDataAccessor> addNewThreadProgressContainerToUi(String parentId, String titleMessage) {
        if (parentId == null) {
    ...
    public Optional<String> getAutomergePath() {
        if (!advancedProgressCbxEnableAutomerge.isSelected()) {
            return Optional.empty();
        }
