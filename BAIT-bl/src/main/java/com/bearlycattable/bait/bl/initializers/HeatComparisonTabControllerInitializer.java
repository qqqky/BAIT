...
import com.bearlycattable.bait.bl.controllers.HeatComparisonTabController;
...
public class HeatComparisonTabControllerInitializer {
    ...
    private HeatComparisonTabControllerInitializer() {
        throw new IllegalStateException("Must use static factory");
    }

    private HeatComparisonTabControllerInitializer(HeatComparisonTabController controller, HeatVisualizerController mainController) {
        this.controller = controller;
        this.mainController = mainController;
    }

    public static HeatComparisonTabControllerInitializer getInitializer(HeatComparisonTabController controller, HeatVisualizerController mainController) {
        return new HeatComparisonTabControllerInitializer(controller, mainController);
    }
