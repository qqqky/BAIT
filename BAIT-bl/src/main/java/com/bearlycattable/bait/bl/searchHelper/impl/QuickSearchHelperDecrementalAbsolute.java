...
public final class QuickSearchHelperDecrementalAbsolute extends AbstractQuickSearchHelper implements CustomKeyGenerator {

    private static final Logger LOG = Logger.getLogger(QuickSearchHelperDecrementalAbsolute.class.getName());
    ...
    public QuickSearchHelperDecrementalAbsolute(@NonNull SimpleSearchHelperCreationContext creationContext) {
