...
//  */
//
// package com.bearlycattable.bait.commons.extern.bitcoinjExtern.addresses;
//
//
...
//
// import com.bearlycattable.bait.commons.extern.bitcoinjExtern.ECKey;
// import com.bearlycattable.bait.commons.extern.bitcoinjExtern.ScriptType;
// import com.bearlycattable.bait.commons.extern.bitcoinjExtern.addresses.segwitEncoding.Bech32;
// import com.bearlycattable.bait.commons.extern.bitcoinjExtern.networkParameters.NetworkParameters;
// import com.bearlycattable.bait.commons.extern.bitcoinjExtern.networkParameters.NetworkUtils;
// import com.bearlycattable.bait.commons.extern.guavaExtern.UnsignedBytes;
...
//         if (params == null) {
//             for (NetworkParameters p : NetworkUtils.NETWORKS) {
...
//         UtilsGuava.checkArgument(key.isCompressed(), "only compressed keys allowed");
