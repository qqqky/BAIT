...
package com.bearlycattable.bait.commons.extern.bitcoinjExtern.addresses.segwitEncoding;
...
import com.bearlycattable.bait.commons.extern.bitcoinjExtern.addresses.AddressFormatException;
...
public class Bech32 {
    ...
    public static String encode(Encoding encoding, String hrp, final byte[] values) {
        UtilsGuava.checkArgument(hrp.length() >= 1, "Human-readable part is too short");
        UtilsGuava.checkArgument(hrp.length() <= 83, "Human-readable part is too long");
