 ...
 * 256 + b}). The corresponding methods that treat the values as signed are found in {
...
public final class UnsignedBytes {
    ...
    public static byte checkedCast(long value) {
        UtilsGuava.checkArgument(value >> Byte.SIZE == 0, "out of range: %s", value);
        return (byte) value;
    }
    ...
    public static byte min(byte... array) {
        UtilsGuava.checkArgument(array.length > 0);
    ...
    public static byte parseUnsignedByte(String string, int radix) {
        int parse = Integer.parseInt(Objects.requireNonNull(string), radix);
        ...
        enum UnsafeComparator implements Comparator<byte[]> {
            ...
            public int compare(byte[] left, byte[] right) {
                ...
                for (i = 0; i < strideLimit; i += stride) {
                    ...
                    if (lw != rw) {
                        if (BIG_ENDIAN) {
                            return UtilsGuava.compareAsUnsignedLongs(lw, rw);
                        }
    ...
    public static void sort(byte[] array, int fromIndex, int toIndex) {
        Objects.requireNonNull(array);
        UtilsGuava.checkPositionIndexes(fromIndex, toIndex, array.length);
